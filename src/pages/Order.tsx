                ...
                <div className="w-full max-w-xl rounded-3xl border border-black/10 bg-brand-bg p-5 shadow-xl sm:p-6">
                  ...
                  <div className="mt-5 grid gap-3 sm:grid-cols-3">
                    <button
                      ...
                      className="rounded-2xl bg-brand-ink px-5 py-3 text-sm font-semibold text-brand-bg hover:bg-brand-ink/95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-ink"
                    >
                      WhatsApp (PickMe Flash)
                    </button>

                    <button
                      type="button"
                      onClick={placeViaPickMe}
                      className="rounded-2xl border border-brand-ink/25 bg-white/60 px-5 py-3 text-sm font-semibold text-brand-ink hover:bg-white/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-ink"
                    >
                      Open PickMe Food
                    </button>
                    ...
                    <button
                      type="button"
                      onClick={placeViaUber}
                      className="rounded-2xl border border-brand-ink/25 bg-white/60 px-5 py-3 text-sm font-semibold text-brand-ink hover:bg-white/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-ink"
                    >
                      Open Uber Eats
                    </button>

                    {/* keep Back button full-width under them */}
                    <button
                      type="button"
                      onClick={() => setOpen(false)}
                      className="sm:col-span-3 rounded-2xl border border-brand-ink/25 bg-transparent px-5 py-3 text-sm font-semibold text-brand-ink hover:bg-black/5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-ink"
                    >
                      Back to edit
                    </button>
                  </div>
